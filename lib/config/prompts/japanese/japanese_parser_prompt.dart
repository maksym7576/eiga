...
correct, or improve translation in any way — treat it as fixed, read-only.

INPUT: {"phraseId": <id>, "japaneseText": "<original>", "translation": "<fixed target-language text, do not alter>"}
...
STEP 3 — Split translation by whitespace into words, positions 1..M.
Do not alter translation itself.
...
OUTPUT FORMAT (array if batch):
{
  ...
  "translation": "<as provided, unchanged>",
  "blocks": [
    {
      "b_pos": 1,
...
EXAMPLE:
INPUT: {"phraseId": 1, "japaneseText": "「好き」", "translation": "Like"}
OUTPUT:
{
  "phraseId": 1,
  "japaneseText": "「好き」",
