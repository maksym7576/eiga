...
class MainMobileView extends ConsumerStatefulWidget {
  const MainMobileView({super.key});

  @override
  ConsumerState<MainMobileView> createState() => _MainMobileViewState();
}

class _MainMobileViewState extends ConsumerState<MainMobileView> {
