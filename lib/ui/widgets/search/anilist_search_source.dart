...
class AniListSearchSource implements SearchSource<UnifiedMetadataDTO, void> {
  @override String get key => SearchSourceKeys.anilist;
  @override String get title => 'AniList Search';
  @override String get searchHint => 'Search for an anime...';
  ...
  Future<List<UnifiedMetadataDTO>> search(String query, Map<String, dynamic> filters, dynamic ref) async {
    try {
      ...
      if (e is AniListDisabledException) ref.read(providerStatusProvider(MetadataProviderType.anilist).notifier).state = ProviderStatus.error;
      rethrow;
    }
  }
  ...
  @override String entryId(UnifiedMetadataDTO entry) => entry.anilistId?.toString() ?? entry.sourceId;
